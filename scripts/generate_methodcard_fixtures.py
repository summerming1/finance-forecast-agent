...
from finance_forecast_agent.method_cards import PaperTextLoader, document_from_paper_spec, method_card_from_paper_spec, write_methodcard_fixture
...
def main() -> None:
    ...
    for paper in built_in_paper_specs():
        generated = document_from_paper_spec(paper)
        paper_path = text_dir / f'{paper.paper_id}.txt'
        paper_path.write_text(generated.text, encoding='utf-8')
        document = loader.load(paper_path)
